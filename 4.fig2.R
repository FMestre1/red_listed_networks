...
out1 <- rasterVis::levelplot(nt_outdegree, col.regions=my.col.regions, at=outd_min_max, main = "Not-threatened")
out2 <- rasterVis::levelplot(t_outdegree, col.regions=my.col.regions, at=outd_min_max, main = "Threatened")
#
outdeg_plot <- ggplot() +
...
bt_cent1 <- rasterVis::levelplot(nt_centrality, col.regions=my.col.regions, at=btcent_min_max, main = "Not-threatened")
bt_cent2 <- rasterVis::levelplot(t_centrality, col.regions=my.col.regions, at=btcent_min_max, main = "Threatened")
#
btcent_plot <- ggplot() +
...
close_min_max <- seq(0, 2, length.out = 100)
close_cent1 <- rasterVis::levelplot(nt_outdegree, col.regions=my.col.regions, at=close_min_max, main = "Not-threatened")
close_cent2 <- rasterVis::levelplot(t_outdegree, col.regions=my.col.regions, at=close_min_max, main = "Threatened")
#
close_plot <- ggplot() +
